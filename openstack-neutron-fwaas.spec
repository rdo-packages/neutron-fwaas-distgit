...
Patch0002: 0002-db-add-missing-primary-key-in-firewall_group_associa.patch
Patch0003: 0003-Set-service-type-when-registering-provider-config.patch
Patch0004: 0004-Use-reader-context-for-DB-queries.patch
